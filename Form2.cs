...
namespace RestaurantManagementSystem
{
    public partial class Form2 : Form
    {
        ...
        public int deleteinqueue(string searchitemName, string searchitemType, int searchtableNo,  int searchquantity)
        {
            ...
            // error proof
            int totalcounter = 0, queuelistcounter = 0;
            ...
            else if (totalcounter == searchquantity) // delete all if equal
            {
                totalqueue -= queuelistcounter;
            }
            else // delete all and prompt if food is prepared
            {
                int itempreparedcount = searchquantity - totalcounter;
                totalqueue -= queuelistcounter;

                if ( itempreparedcount > 0 )
                    MessageBox.Show(String.Format("{0} of {1} had already been prepared", itempreparedcount, searchitemName), "Warning To Counter");
            }
